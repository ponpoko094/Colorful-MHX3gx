...
void ProcessPlus::Write8(std::vector<u32> address, u8 value) {
  for (int i = 0; i < address.size(); i++) {
    Process::Write8(address[i], value);
  }
}
...
void ProcessPlus::Write8(std::vector<u32> pointer, u32 offset, u8 value) {
  u32 address;
...
void ProcessPlus::Write8(u32 pointer, u32 offset1, u32 offset2, u8 value) {
  u32 address1, address2;
  Process::Read32(pointer, address1);
  Process::Read32(address1 + offset1, address2);
  Process::Write8(address2 + offset2, value);
}

void ProcessPlus::Write8(std::vector<u32> pointer, u32 offset1, u32 offset2,
                         u8 value) {
  u32 address1, address2;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address1);
    Process::Read32(address1 + offset1, address2);
    Process::Write8(address2 + offset2, value);
  }
}
...
void ProcessPlus::Write16(std::vector<u32> address, u16 value) {
  for (int i = 0; i < address.size(); i++) {
    Process::Write16(address[i], value);
  }
}
...
void ProcessPlus::Write16(std::vector<u32> pointer, u32 offset, u16 value) {
  u32 address;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address);
    Process::Write16(address + offset, value);
...
void ProcessPlus::Write16(u32 pointer, u32 offset1, u32 offset2, u16 value) {
  u32 address1, address2;
  Process::Read32(pointer, address1);
  Process::Read32(address1 + offset1, address2);
  Process::Write16(address2 + offset2, value);
}

void ProcessPlus::Write16(std::vector<u32> pointer, u32 offset1, u32 offset2,
                          u16 value) {
  u32 address1, address2;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address1);
...
void ProcessPlus::Write32(std::vector<u32> address, u32 value) {
  for (int i = 0; i < address.size(); i++) {
...
void ProcessPlus::Write32(std::vector<u32> pointer, u32 offset, u32 value) {
  u32 address;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address);
    Process::Write32(address + offset, value);
...
void ProcessPlus::Write32(u32 pointer, u32 offset1, u32 offset2, u32 value) {
  u32 address1, address2;
  Process::Read32(pointer, address1);
  Process::Read32(address1 + offset1, address2);
  Process::Write32(address2 + offset2, value);
}

void ProcessPlus::Write32(std::vector<u32> pointer, u32 offset1, u32 offset2,
                          u32 value) {
  u32 address1, address2;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address1);
...
void ProcessPlus::Write64(std::vector<u32> address, u64 value) {
  for (int i = 0; i < address.size(); i++) {
    Process::Write64(address[i], value);
  }
}
...
void ProcessPlus::Write64(std::vector<u32> pointer, u32 offset, u64 value) {
  u32 address;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address);
    Process::Write64(address + offset, value);
...
void ProcessPlus::Write64(u32 pointer, u32 offset1, u32 offset2, u64 value) {
  u32 address1, address2;
  Process::Read32(pointer, address1);
  Process::Read32(address1 + offset1, address2);
  Process::Write64(address2 + offset2, value);
}

void ProcessPlus::Write64(std::vector<u32> pointer, u32 offset1, u32 offset2,
                          u64 value) {
  u32 address1, address2;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address1);
...
void ProcessPlus::WriteFloat(std::vector<u32> address, float value) {
  for (int i = 0; i < address.size(); i++) {
    Process::WriteFloat(address[i], value);
  }
}
...
void ProcessPlus::WriteFloat(u32 pointer, u32 offset1, u32 offset2,
                             float value) {
  u32 address1, address2;
  Process::Read32(pointer, address1);
  Process::Read32(address1 + offset1, address2);
  Process::WriteFloat(address2 + offset2, value);
}

void ProcessPlus::WriteFloat(std::vector<u32> pointer, u32 offset1, u32 offset2,
                             float value) {
  u32 address1, address2;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address1);
...
void ProcessPlus::WriteDouble(std::vector<u32> address, double value) {
  for (int i = 0; i < address.size(); i++) {
    Process::WriteDouble(address[i], value);
  }
}
...
void ProcessPlus::WriteDouble(u32 pointer, u32 offset1, u32 offset2,
                              double value) {
  u32 address1, address2;
  Process::Read32(pointer, address1);
  Process::Read32(address1 + offset1, address2);
  Process::WriteDouble(address2 + offset2, value);
}

void ProcessPlus::WriteDouble(std::vector<u32> pointer, u32 offset1,
                              u32 offset2, double value) {
  u32 address1, address2;
  for (int i = 0; i < pointer.size(); i++) {
    Process::Read32(pointer[i], address1);
    Process::Read32(address1 + offset1, address2);
...
u8 ProcessPlus::Read8(u32 pointer, u32 offset1, u32 offset2) {
  u32 address1, address2;
  u8 value;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read8(address2 + offset2, value);
      return value;
    }
  }
  return 0;
...
u16 ProcessPlus::Read16(u32 pointer, u32 offset1, u32 offset2) {
  u32 address1, address2;
  u16 value;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read16(address2 + offset2, value);
      return value;
    }
  }
  return 0;
...
u32 ProcessPlus::Read32(u32 pointer, u32 offset1, u32 offset2) {
  u32 address1, address2;
  u32 value;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read32(address2 + offset2, value);
      return value;
    }
  }
  return 0;
...
u64 ProcessPlus::Read64(u32 pointer, u32 offset1, u32 offset2) {
  u32 address1, address2;
  u64 value;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read64(address2 + offset2, value);
      return value;
    }
  }
  return 0;
...
float ProcessPlus::ReadFloat(u32 pointer, u32 offset1, u32 offset2) {
  u32 address1, address2;
  float value;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::ReadFloat(address2 + offset2, value);
      return value;
    }
  }
  return 0;
...
double ProcessPlus::ReadDouble(u32 pointer, u32 offset1, u32 offset2) {
  u32 address1, address2;
  double value;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::ReadDouble(address2 + offset2, value);
      return value;
    }
  }
  return 0;
...
void ProcessPlus::Add8(u32 pointer, u32 offset1, u32 offset2,
                       u8 increase_value) {
  u8 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read8(address2 + offset2, data);
      Process::Write8(address2 + offset2, data + increase_value);
    }
  }
}
...
void ProcessPlus::Add16(u32 pointer, u32 offset1, u32 offset2,
                        u16 increase_value) {
  u16 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read16(address2 + offset2, data);
      Process::Write16(address2 + offset2, data + increase_value);
    }
  }
}
...
void ProcessPlus::Add32(u32 pointer, u32 offset1, u32 offset2,
                        u32 increase_value) {
  u32 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read32(address2 + offset2, data);
      Process::Write32(address2 + offset2, data + increase_value);
    }
  }
}
...
void ProcessPlus::Add64(u32 pointer, u32 offset1, u32 offset2,
                        u64 increase_value) {
  u64 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::Read64(address2 + offset2, data);
      Process::Write64(address2 + offset2, data + increase_value);
    }
  }
}
...
void ProcessPlus::AddFloat(u32 pointer, u32 offset1, u32 offset2,
  ...
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::ReadFloat(address2 + offset2, data);
      Process::WriteFloat(address2 + offset2, data + increase_value);
    }
  }
}
...
void ProcessPlus::AddDouble(u32 pointer, u32 offset1, u32 offset2,
  ...
  if (address1 != 0) {
    Process::Read32(address1 + offset1, address2);
    if (address2 != 0) {
      Process::ReadDouble(address2 + offset2, data);
      Process::WriteDouble(address2 + offset2, data + increase_value);
    }
  }
}
...
void ProcessPlus::Sub8(u32 pointer, u32 offset1, u32 offset2,
                       u8 decrease_value) {
  u8 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    ...
    if (address2 != 0) {
      Process::Read8(address2 + offset2, data);
      Process::Write8(address2 + offset2, data - decrease_value);
    }
  }
}
...
void ProcessPlus::Sub16(u32 pointer, u32 offset1, u32 offset2,
                        u16 decrease_value) {
  u16 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    ...
    if (address2 != 0) {
      Process::Read16(address2 + offset2, data);
      Process::Write16(address2 + offset2, data - decrease_value);
    }
  }
}
...
void ProcessPlus::Sub32(u32 pointer, u32 offset1, u32 offset2,
                        u32 decrease_value) {
  u32 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    ...
    if (address2 != 0) {
      Process::Read32(address2 + offset2, data);
      Process::Write32(address2 + offset2, data - decrease_value);
    }
  }
}
...
void ProcessPlus::Sub64(u32 pointer, u32 offset1, u32 offset2,
                        u64 decrease_value) {
  u64 data;
  u32 address1, address2;
  Process::Read32(pointer, address1);
  if (address1 != 0) {
    ...
    if (address2 != 0) {
      Process::Read64(address2 + offset2, data);
      Process::Write64(address2 + offset2, data - decrease_value);
    }
  }
}
...
void ProcessPlus::SubFloat(u32 pointer, u32 offset1, u32 offset2,
  ...
  if (address1 != 0) {
    ...
    if (address2 != 0) {
      Process::ReadFloat(address2 + offset2, data);
      Process::WriteFloat(address2 + offset2, data - decrease_value);
    }
  }
}
...
void ProcessPlus::SubDouble(u32 pointer, u32 offset1, u32 offset2,
  ...
  if (address1 != 0) {
    ...
    if (address2 != 0) {
      Process::ReadDouble(address2 + offset2, data);
      Process::WriteDouble(address2 + offset2, data - decrease_value);
    }
  }
}
