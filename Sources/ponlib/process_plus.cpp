...
void ProcessPlus::Add8(u32 pointer,
                       u32 offset1,
                       u32 offset2,
                       u8 increase_value) {
  u8 data;
...
void ProcessPlus::Add16(u32 pointer,
                        u32 offset1,
                        u32 offset2,
                        u16 increase_value) {
  u16 data;
...
void ProcessPlus::Add32(u32 pointer,
                        u32 offset1,
                        u32 offset2,
                        u32 increase_value) {
  u32 data;
...
void ProcessPlus::Add64(u32 pointer,
                        u32 offset1,
                        u32 offset2,
                        u64 increase_value) {
  u64 data;
...
void ProcessPlus::AddFloat(u32 pointer,
                           u32 offset1,
                           u32 offset2,
...
void ProcessPlus::AddDouble(u32 pointer,
                            u32 offset1,
                            u32 offset2,
...
void ProcessPlus::Sub8(u32 pointer,
                       u32 offset1,
                       u32 offset2,
                       u8 decrease_value) {
  u8 data;
...
void ProcessPlus::Sub16(u32 pointer,
                        u32 offset1,
                        u32 offset2,
                        u16 decrease_value) {
  u16 data;
...
void ProcessPlus::Sub32(u32 pointer,
                        u32 offset1,
                        u32 offset2,
                        u32 decrease_value) {
  u32 data;
...
void ProcessPlus::Sub64(u32 pointer,
                        u32 offset1,
                        u32 offset2,
                        u64 decrease_value) {
  u64 data;
...
void ProcessPlus::SubFloat(u32 pointer,
                           u32 offset1,
                           u32 offset2,
...
void ProcessPlus::SubDouble(u32 pointer,
                            u32 offset1,
                            u32 offset2,
